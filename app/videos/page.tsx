  ...
  return (
    <>
      ...
      <main className="pt-24">
        <div className="bg-gradient-to-r from-[#1a365d] to-[#1e4976] text-white py-16">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl font-bold mb-4">Video Tutorials</h1>
            <p className="text-xl text-gray-200">Watch our comprehensive guides on financial planning and investing</p>
          </div>
        </div>
